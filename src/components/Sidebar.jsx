...
export function Sidebar() {
  ...
  return (
    <nav className="fixed w-full z-50 bg-white shadow">
      <div className="max-w-6xl mx-auto px-8">
        <div className="flex h-14 items-center justify-between">
          <a href="/" className="flex items-center gap-2">
            <div className="w-9 h-9 bg-emerald-600 shadow rounded-full flex items-center justify-center">
          ...
          <div className="hidden lg:flex lg:items-center gap-5">
            ...
            >
              <div className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 tracking-wide bg-gray-100 shadow rounded-lg cursor-pointer">
                Sveikatos skaičiuoklės
                {renderCaret("health")}
              </div>
              <div
                className={classNames(
                  "absolute right-0 mt-2 bg-white shadow rounded-lg z-50 overflow-hidden w-[30.8rem]",
                ...
                {healthNav.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-auto">
                      <a
                        href={item.href}
                        className="block font-semibold text-gray-700 tracking-wide"
                      >
                        {item.name}
      ...
      >
        <div className="px-4">
          <h3 className="pb-2 text-sm font-semibold text-gray-700">
            Sveikatos skaičiuoklės
          </h3>
          {healthNav.map((item) => (
            <Link
              ...
              className="group relative flex items-center gap-x-4 rounded-lg p-3 text-sm/6 hover:bg-gray-50 -ml-3"
            >
              <div className="flex h-10 w-10 flex-none items-center justify-center rounded-lg bg-gray-50">
                <item.icon
                  aria-hidden="true"
                  className="h-5 w-5 text-gray-600 group-hover:text-emerald-500"
                />
              </div>
              <div className="flex-auto">
